...
exports.buildHeaderRecQuery = (query, req, additionalFields=null, dateField="DocDate") => {
  ...
  if(req.searchKey) {
    ...
    // BUG FIX: Even with a wildcard search, we MUST strictly apply the salesEmployeeCode 
    // and location filters if they are provided, to prevent users from bypassing 
    // role-based restrictions by typing into the search box.
